...
class StyleRRDBNet(nn.Module):
    ...
    """
    # in_nc = 3
    def __init__(self, in_nc, out_nc, w_dim, nf, nb, gc=32, scale_factor=4, num_cond=1, up_channels=None, to_rgb_ks=3, use_pixel_shuffle=True, use_mapping_network=True, global_residual=False):
    ...
    def forward(self, x, cond, z, fea=None):
